		...
		<div class="main-content-wrap clearfix">
			<div id="content">
				...
				?>
                    ...
                    $queryObject = new WP_Query( 'post_type=announcements&posts_per_page=20' );
                    // The Loop!
                            ...
                            <div class="cartoon-box-widget">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="cartoon-box-thumbnail">
                                        <img src="<?php  get_post_meta ( get_the_ID(), 'tn-catoon-image', true ) ?>" />
                                    </div>
                                    <div class="cartoon-box-title">
                                        <?php the_title(); ?>
                                    </div>
                                </a>
                                <span class="authora"><a href="https://www.facebook.com/fulanawho?fref=ts">Fulana Who</a></span>
                            </div>
                        <?php
                        }
                        ?>
					...
					<div id="et-box-author">
						<div id="et-bio-author">
							...
							<p id="author-info">
								<strong>Autor/a<?php /*esc_html_e( 'Author', 'Nexus' );*/ ?>:</strong> <?php the_author_link(); ?>
							</p> <!-- end #author-info -->
